...
mod mbtoken {
    ...
    impl MBToken {
        ...
        fn balance_of_or_zero(&self, owner: &AccountId) -> u128 {
        ...
        fn assert_transfer_event(
            ...
            let expected_topics = vec![
                encoded_into_hash(&PrefixedValue {
                    value: b"MBToken::Transfer",
                    prefix: b"",
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MBToken::Transfer::from",
                    value: &expected_from,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MBToken::Transfer::to",
                    value: &expected_to,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MBToken::Transfer::value",
