...
mod mb_projects {
    ...
    pub struct MBProjects {
        ...
        count:u64,
        metadata_content_of:StorageHashMap<(u64, u64), String>,
    }
    ...
    impl MBProjects {
        ...
        pub fn new() -> Self {
            Self {
                ...
                count:0,
                metadata_content_of: Default::default(),
            }
        }
        ...
        /**
          ...
          */
        #[ink(message)]
        pub fn create_for(&mut self,_owner:AccountId, _metadata:String) -> u64
        {
            self.count +=1;
            let project_id:u64 = self.count;
            assert_eq!(self.mint(_owner,project_id),Ok(()));
        ...
        /// Creates a new token.
        #[ink(message)]
        pub fn mint(&mut self,owner:AccountId, id: TokenId) -> Result<(), Error> {
    ...
    mod tests {
        ...
        fn mint_existing_should_fail() {
            ...
            assert_eq!(erc721.mint(accounts.alice,1), Err(Error::TokenExists));
        }
        ...
        fn invalid_transfer_should_fail() {
            ...
            // Create token Id 2.
            assert_eq!(erc721.mint(accounts.alice,2), Ok(()));
            // Alice owns 1 token.
            assert_eq!(erc721.balance_of(accounts.alice), 1);
